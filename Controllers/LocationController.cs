...
namespace muralPass.Controllers
{
    ...
    public class LocationController : ControllerBase
    {
        ...
        // GET: api/Location
        [HttpGet]
        public async Task<ActionResult<IEnumerable<PointOfInterest>>> GetPointOfInterest()
        {
        ...
        {
            var pointOfInterest = await _context.PointOfInterest.FindAsync(id);
        ...
        {
            return _context.PointOfInterest.Any(e => e.Id == id);
        }
    }
}
